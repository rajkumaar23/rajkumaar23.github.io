...
\begin{itemize}[leftmargin=0in, label={}]
	\small{\item{
		\textbf{Areas of Interest}{: Distributed Systems, Cloud Computing, Full Stack Development,  Mobile Apps, Cyber Security} \\
		\textbf{Languages and Frameworks}{: Go, Python, PHP, Node.js, ReactJS, C++, Java, JavaScript, Protobuf, SQL, Android} \\
...
\resumeSubHeadingListStart
  \resumeSubheading
{NVIDIA}{Nov 2024 -- Present}
{Software Engineer II $|$ Tech : GoLang,  Bash, Slurm}{Seattle, WA}
\resumeItemListStart
\resumeItem{
Building break/fix workflows to automate data center operations.
}
\resumeItemListEnd

\resumeSubheading
{Hewlett Packard Enterprise}{Feb 2024 -- Nov 2024}
{Software Engineer II $|$ Tech : GoLang,  React, Kubernetes, Terraform}{Seattle, WA}
\resumeItemListStart
\resumeItem{Developed and optimized front-end and back-end features for SaaS solutions, including role-based access controls, Kubernetes integration, and automated TLS renewals, improving platform reliability and user experience.}
\resumeItem{Led infrastructure enhancements by securing EKS deployments, implementing cloud quotas, and improving CI/CD pipelines, reducing deployment times and ensuring smoother cloud operations.}
\resumeItemListEnd

  
\resumeSubheading
{Cruise - Self Driving Cars}{May 2023 -- Aug 2023}
{Software Engineer Intern $|$ Tech : GoLang,  gRPC, Docker,  GCP}{Bellevue, WA}
\resumeItemListStart
\resumeItem{Developed a self-service snapshot restoration feature for virtual machines used by Cruise engineers,  minimizing developer hours spent on a single restoration by an impressive \textbf{80\%}.}
\resumeItemListEnd
