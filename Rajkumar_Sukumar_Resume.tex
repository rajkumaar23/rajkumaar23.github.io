...
\section{Education}
  \resumeSubHeadingListStart
      \resumeSubheading  {Arizona State University}{August 2022 -- May 2024} {Master of Science in Computer Science $|$ {GPA : 3.94/4.0}} {Tempe, AZ}
...
\section{Experience}
  ...
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
      {Cruise LLC}{May 2023 -- August 2023}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Notifications} - Leveraged the `nchan' module for nginx to build a scalable and real-time notifications using websockets.}        
        \resumeItem{\textbf{Contest Management} - Migrated the entire contest/problem management portal written in legacy EmberJS to ReactJS.}
