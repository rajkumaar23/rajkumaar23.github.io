...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Engineer Intern $|$ Tech : PHP,  ReactJS, SaltStack, AWS}{Bangalore, Karnataka}
      \resumeItemListStart
        \resumeItem{Optimised various SQL queries upto a maximum of \textbf{10x}.}
        \resumeItem{Built necessary REST APIs and revamped the entire Host Your Contest portal, used by contest managers, to ReactJS.}
    ...
    \resumeSubheading
      ...
      {C/C++ Virtual Teaching Assistant $|$ Tech: C/C++}{Remote}
      \resumeItemListStart
